...
module.exports.run = async function({ api, event, args }) {
		...
		const prefix = "/";
		const CREATORLINK = "https://www.facebook.com/RanielHiyanBigdick";
		const BOTCREATOR = "Raniel Hiyan";
		const BOTNAME = "Miko bot";
		const FILESOWNER = "Raniel";
...
✫ Thanks for using my bot`,
						attachment: fs.createReadStream(__dirname + "/cache/video/GMdR5BmlDErujXoDABITpjU3haRNbmdjAAAF.mp4")
				}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/video/GMdR5BmlDErujXoDABITpjU3haRNbmdjAAAF.mp4"));
		};
		...
		request(encodeURI(link[linkIndex]))
				...
				.pipe(fs.createWriteStream(__dirname + "/cache/video/GMdR5BmlDErujXoDABITpjU3haRNbmdjAAAF.mp4"))
				.on("close", callback);
};