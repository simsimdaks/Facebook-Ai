...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/100092248658233";
		const BOTCREATOR = "Raniel";
		const BOTNAME = "𝐀𝐮𝐭𝐨𝐛𝐨𝐭 𝐛𝐲 Raniel";
...
⁂ Bot Name: Autobot
✧ Bot Admin: Raniel Bigdick
♛ Bot Admin Link: https://www.facebook.com/100092248658233
❂ Bot Prefix: ${prefix}
✬ Today is: ${juswa} 
